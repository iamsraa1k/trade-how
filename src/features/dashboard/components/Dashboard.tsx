    ...
    return (
        <div className="space-y-5 flex flex-col pt-2">
            <div className="flex flex-col lg:flex-row gap-4">
                <div className="flex-1 flex flex-col sm:flex-row justify-between items-center p-6 sm:p-8 relative overflow-hidden glass-card">
                    <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/10 via-purple-500/5 to-transparent dark:from-indigo-500/20 dark:via-purple-500/10 z-0"></div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center glass p-4 sm:p-5 rounded-2xl mt-2">
